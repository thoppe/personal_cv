...
{
  \begin{itemize}
  \item Developed analytic tools to process the text of NIH grants and publications using distributional embeddings (e.g. word2vec).
    ...
    \item Designed and validated an interagency government blockchain to detect grant duplication with minimal shared data.
    \item Restored historical texts from books and PDFs into actionable data.
  \end{itemize}
}
