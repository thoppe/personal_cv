...
\vspace{-2em}
\begin{itemize}
\item  \textbf{Machine learning}: Natural Language Processing (NLP), Convolutional Neural Networks (CNN), Generative Adversarial Networks (GANs), Transformers (BERT, GPT), Tensorflow, pyTorch, word2vec.
\item  \textbf{Programming \& Database}: Python, C\texttt{++}, JavaScript, SQL, NoSQL (MongoDB, Elasticsearch).
