...
\newcommand{\CVorcid}{0000-0002-4694-3050}
...
\begin{cleanCV}
  ...
  \item Led multiple teams across CDC to develop and implement cutting-edge policies, guidance, and strategies for AI/ML adoption, including conversational AI (ChatGPT), and the infrastructure needed to support AI/ML implementation. Extensive experience presenting to federal and industry audiences on Trustworthy AI, implementation, and development.
   \item Respected and well-cited author in AI/ML and biomedical research, with work addressing disparities in NIH funding (\href{https://www.science.org/doi/10.1126/sciadv.aaw7238}{Topic Choice}: 600 citations, key evidence used by the \href{https://github.com/thoppe/personal_cv/blob/6f21f1676ee58b81e557691739578d01d903b341/tex/src/reference_documents/191220_ltr_to_nih_about_grant_disparities.pdf}{Congressional Black Caucus}), open citations (\href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6786512/}{NIH Open Citation Collection}: 100 citations), and a foundational AI dataset for training large language models (\href{https://arxiv.org/abs/2101.00027}{The Pile}: 850 citations).
...
\WorkExperience
{\EmployerLogo[width=0.70in]{src/assets/logos/white-house-gray.pdf}}
...
\WorkExperience
{\EmployerLogo[width=0.60in]{src/assets/logos/cdc-gray.pdf}}
...
\WorkExperience
{\EmployerLogo[width=0.65in]{src/assets/logos/nih-gray.pdf}}
...
\WorkExperienceX
{2026}
{Apolitical Government AI 100}
{Recognized among global public sector leaders advancing AI adoption, governance, and workforce capability in government}

\WorkExperienceX
{2026}
{MeriTalk America 250 Powering Progress Award (AI Innovator)}
{Recognized for advancing artificial intelligence innovation and mission impact in federal public health as part of a national cohort of government technology leaders}

\WorkExperienceX
{2025}
{GovExec Federal 100 Award (Fed100)}
{Recognized as one of 100 leaders driving innovation and impact in federal IT through data, analytics, and artificial intelligence}
...
{Co-chair (2024-2025), CDC representative (2021-2026)}
...
\WorkExperienceX
{2023}
{Utility and Risks to CDC of Conversational Artificial Intelligence (AI) Technologies like ChatGPT (CDC)}
{Tiger Team Lead}
...
{Travis Hoppe, Ben Rogers, et al.}
{https://www.cdc.gov/ai/resources/considerations-for-genai-in-public-health.html}
...
{Travis Hoppe, Ben Rogers, et al.}
{https://www.cdc.gov/ai/resources/considerations-for-agentic-research-in-public-health.html}
{Centers for Disease Control and Prevention}
