...
{Active presenter and attendee in both the data community (Data Wranglers and Hack \& Tell) and scientific enterprise (Biophysical society, American Physical Society, and more). Firm believer in STEM outreach to public schools from professionals.}
...
\SkillSet{Data Science}{
  ...
  \Skill{Supervised Learning}{Support Vector Machines, Naive Bayes}, 
